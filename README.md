...
바이브코딩 컨설팅 케이스 스터디. 비개발자가 AI 도구를 활용해 에셋스토어 데모 수준의 게임을 직접 만들어보는 것이 목표.

- 1번째 케이스: [Beluca-Pipeline](https://github.com/wooson00308/Beluca-Pipeline) — VFX 파이프라인 도구 (Python/PySide6)
- 2번째 케이스: 이 레포 — Unity 2D 플랫포머
